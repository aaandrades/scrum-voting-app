...
import './TermsConditionsEntry.css';

export default function TermsConditionsEntry() {
  const [open, setOpen] = useState(false);

  const onOpen = () => setOpen(true);
  const onClose = () => setOpen(false);

  const dialogId = 'terms-conditions-dialog';
  ...
  return (
    <>
      ...
      <Modal isOpen={open} onClose={onClose} title="Terms and Conditions of Use" id={dialogId}>
        <p>
